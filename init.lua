...
vim.keymap.set('', '<C-w>1', '1gt', {desc = 'Go to tab1'})
vim.keymap.set('', '<C-w>2', '2gt', {desc = 'Go to tab2'})
vim.keymap.set('', '<C-w>3', '3gt', {desc = 'Go to tab3'})
vim.keymap.set('', '<C-w>4', '4gt', {desc = 'Go to tab4'})
vim.keymap.set('', '<C-w>5', '5gt', {desc = 'Go to tab5'})
vim.keymap.set('', '<C-w>6', '6gt', {desc = 'Go to tab6'})
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-w>g', builtin.live_grep, { desc = '[S]earch by [G]rep' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<C-w>f', require('telescope.builtin').lsp_type_definitions, '[G]oto [T]ype Definition')
